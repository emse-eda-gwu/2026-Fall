...
names(schedule) <- str_to_title(names(schedule))
  ...
  rename(
      ...
      `Reading Reflection` = Assign
  ) %>%
  select(
      Week, Date = Date_md, Quiz, Class, `Reading Reflection`,
...
<center>
[Final Interviews](./class/interviews.html) will be held virtually December 09-11 (sign up [here](https://calendar.app.google/JirZBvZbX76T9heY6))
</center>
