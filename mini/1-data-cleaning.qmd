...
Open your course repo (`eda-f26/eda-netID`) in Positron using **File › Open Folder** and open it to the `mini1` folder. If you haven't cloned your course repo yet, follow the steps in [HW1](../hw/1-agentic-workflows-and-github.html#clone-your-course-repo) first.
