...
Open your course repo (`eda-f26/eda-netID`) in Positron using **File › Open Folder** and open it to the `mini3` folder.

Everything for this assignment lives in the `mini3` folder. Inside it you'll find `report.qmd` and a `data` folder. Click on `report.qmd`. That is the primary file you will edit to conduct your analysis.

Update the YAML with your name, a title, the date, etc.

Be sure to delete any of the existing text / code in `report.qmd` before submitting - it is just there as a helpful guide.
