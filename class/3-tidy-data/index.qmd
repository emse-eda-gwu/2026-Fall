...
<center>
<img src="images/tidy-data.png" width=100%>
</center>
...
![](images/tidy-data.png){width="100%"}
...
## {{< fa magnifying-glass >}} **Document your source like a museum curator**
...
- north_america_bear_killings.txt: [source](https://en.wikipedia.org/wiki/List_of_fatal_bear_attacks_in_North_America)
...
**Other good examples**: See the [Example Projects](https://eda.seas.gwu.edu/2026-Fall/project/examples.html) page
...
# 1. Use [this link](https://docs.google.com/spreadsheets/d/1cXNvWVfZ-WN4oLqbhv76cFTXPBi0KCiQdkCG7ivm7i4/edit?usp=sharing) to form teams

# 2. Sign up [here](https://calendar.app.google/niXopBudj9t4pmbj7) for your team proposal 1-on-1 with Prof. Helveston

# 3. [HW 3](https://eda.seas.gwu.edu/2026-Fall/hw/3-cleaning-data.html) is due in **2 weeks**