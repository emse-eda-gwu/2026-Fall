...
## {{< fa globe >}} Everything you need will be on the course website:<br>https://eda.seas.gwu.edu/2026-Fall/
...
::: {.fragment}
## 1) `r fa("book")` Weekly Reflections: [HW1](https://eda.seas.gwu.edu/2026-Fall/hw/1-agentic-workflows.html)
:::
