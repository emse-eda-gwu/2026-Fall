...
execute:
  ...
  freeze: false
filters:
  # Lets slides be tagged with a bare {.inverse}; injects the dark background.
  - at: pre-quarto
    path: inverse-bg.lua
---
...
## Week 1: [Getting Started]{.fancy} {.inverse}
...
## **Class goal**: translate _data_ into _information_ {.inverse .center}

![](images/truth.png){fig-align="center" width="80%"}
...
## Data exploration: an iterative process {background-color="#fff" .center}

![](images/eda.png){fig-align="center" width="600"}
...
### 1) `r fa("book")` Weekly Homework / Readings: [HW1](https://eda.seas.gwu.edu/2026-Fall/hw/1-tidy-data.html)
...
## [Grades]{.center} {background-color="#fff"}

![](https://eda.seas.gwu.edu/2026-Fall/figs/grade-breakdown-1.png){fig-align="center" width="90%"}
...
> -- Austin Kleon, from [Steal Like An Artist](https://austinkleon.com/steal/)&ensp;
> :::
...
## [Quick demo]{.center} {.inverse}

### 1. Open `quarto_demo.qmd`
### 2. Click "Render"

![](images/how-qmd-works.png){fig-align="center" width="100%"}
...
## Right now, bookmark this! 👇 {.center}
...
## Don't want to use Markdown? {.inverse .center}

### [Use Visual Mode!]{.red}

![](images/visual-mode.png){fig-align="center" width="700"}
...
### The data frame...<br>in [Excel]{.darkgreen}

![](images/spreadsheet.png){fig-align="center" width="340"}

:::

::: {.column width="50%"}

### The data frame...<br>in `r fa("r-project", fill = "blue")`
...
## The tidyverse: `stringr` + `dplyr` + `readr` + `ggplot2` + ... {.center}

![](images/horst_monsters_tidyverse.jpeg){fig-align="center" width="950"}
...
## Core `tidyverse` concept: chain functions with "pipes" {.center}
...
## Select columns with `select()` {.inverse .center}

![](images/rstudio-cheatsheet-select.png){fig-align="center" width="900"}
...
## Filter for rows with `filter()` {.inverse .center}

![](images/rstudio-cheatsheet-filter.png){fig-align="center" width="900"}
...
## Create new variables with `mutate()` {.inverse .center}

![](images/rstudio-cheatsheet-mutate.png){fig-align="center" width="900"}
