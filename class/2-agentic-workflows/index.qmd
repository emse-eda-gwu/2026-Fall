...
Term             | What it is                          | Button
-----------------|-------------------------------------|------------------
**Branch**       | A safe side-copy to work on         | **New Branch**
**Publish**      | Send your branch up to GitHub       | **Publish branch**
**Pull request** | "Please pull my branch into `main`" | **Create Pull Request**
**Review**       | They read your diff & approve       | *(on GitHub.com)*
**Merge**        | Your work joins their `main`        | **Merge pull request**

<br>

::: {.font110 .darkgreen}
Branch → **Commit** → **Publish** → **Pull Request** → they **Merge**
:::
