...
Your turn: make a repo.
:::

Video recording of this practice: [https://youtu.be/VlD8N0ZClBo](https://youtu.be/VlD8N0ZClBo) 

::: {.font90}

1. GitHub Desktop → **File › New Repository** → name it `demo-repo`<br>Click on the box for "initialize this repository with a README", and choose "None" in the "Git Ignore" and "License" parts
2. **Publish** it to GitHub.com (make it private).
3. In GitHub Desktop, click on "Show in Finder" to open your local clone. 
4. Open the README.md file in Positron and add a line or two of text, save it. 
5. Back in GitHub Desktop, notice the "diff" (showing the changes made).
6. Write a description of your changes in the bottom-left box, then Commit your changes.
7. **Push** your change github.com (button with up arrow at the top)
8. Look at your **History** tab to see changes, then click on "View on GitHub" to confirm your changes are in the main repo.
:::
...
::: {.col .fragment}
### ["clone"]{.center}
Make your own **local copy** of someone else's repo
:::

::: {.col .fragment}
### ["pull request" (PR)]{.center}
**Propose your changes** back — they review, then **merge**
:::
...
1. Pair with a neighbor. In *your* `eda-w2-practice` repo on GitHub.com:<br>**Settings › Collaborators** → add your partner → they **accept** the emailed invite
2. Swap repo links. In GitHub Desktop, **File › Clone Repository** → clone *your partner's* repo
3. **Branch › New Branch** → name it `yourname-edits`
