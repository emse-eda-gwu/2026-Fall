...
1. GitHub Desktop → **File › New Repository** → name it `eda-w2-practice`<br>(for now, ignore the "Git Ignore" and "License" part)
2. **Publish** it to GitHub.com (make it private)
3. Open your repo at GitHub.com, and create a README by clicking on "Create a README"
4. Write something in your README.md file on GitHub.com, then click "commit". The README.md should now be in your repo. 
5. **Fetch** your changes on your local GitHub Desktop app to pull in those changes.
6. On your local computer, open your README.md in Positron, edit it, then view those changes on GitHub Desktop.
7. Write a description of your changes in the bottom-left box, then Commit your changes and **Push** then to github.com. 
8. Change the README again → **Commit** → **Push** → look at **History**
:::
