...
## The one loop for the whole semester
...
2. **Set up Claude Code** and direct it to build something real
3. Learn the **slash commands** that keep a session healthy
...
::: {.font110 .darkgreen}
Edit → **Commit** (with a message) → **Push**. That's the entire cycle.
:::
