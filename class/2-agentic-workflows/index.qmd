...
4. Ask for something harder, e.g., "*collapse everything into a single page website*" at `/effort high`. Note the difference.
...
- You know `/init`, `/model`, `/effort`, `/clear`, `/compact`, `CLAUDE.md`, and skills
