...
::: {.font100}
Missing it, or joined the class late? Flag me now — grab the steps from HW1 or this [2-min walkthrough](https://youtu.be/VlD8N0ZClBo).
:::
...
1. Pair with a neighbor. In *your* `eda-practice` repo on GitHub.com:<br>**Settings › Collaborators** → add your partner → they **accept** the emailed invite
