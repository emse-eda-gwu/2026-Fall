...
Before class, install the packages we'll use in the practice exercises:

```{r}
#| eval: false

install.packages(c('HistData', 'GGally', 'palmerpenguins'))
```

- [R4DS - 10: Exploratory data analysis](https://r4ds.hadley.nz/EDA.html): Provides some more "hands on" strategies for exploring data using R and the **ggplot2** library.
...
- ["Beware Spurious Correlations", Harvard Business Review](https://hbr.org/2015/06/beware-spurious-correlations) (if you don't have a subscription to see it, a backed up version can be found [here](https://github.com/emse-eda-gwu/2026-Fall/raw/main/content/beware-spurious-correlations.pdf)).
...
- Watch [this 15 minute video](https://www.youtube.com/watch?v=fmK5YWWobH8) to learn about the basics of correlation measures.
...
- View the course site [help page](https://eda.seas.gwu.edu/2026-Fall/references.html#choosing-the-right-chart) on choosing the right chart.

### Optional readings

The history of statistical correlation is rather ugly and rooted in racism and eugenics. These readings discuss these topics in more detail:
...
> **This week, consider writing about an example of a correlation that you could (incorrectly) assume was causation.**
